...
sudo wget -qO- https://raw.githubusercontent.com/luanft/boothshell/main/commands > /opt/boothshell/.env
...
sudo wget -qO- https://raw.githubusercontent.com/luanft/boothshell/main/photoshell.service > /opt/boothshell/photoshell.service
