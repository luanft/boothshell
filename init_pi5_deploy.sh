...
touch /home/luant/machi_deployment/install_wifi.sh
chmod +x /home/luant/machi_deployment/install_wifi.sh
...
HITI_SCRIPT="/home/luant/machi_deployment/update_hiti_ip.sh"
...
exec /home/luant/machi_deployment/PhotoBoothLite-1.1.0-arm64.AppImage > log.txt 2>&1
EOF
